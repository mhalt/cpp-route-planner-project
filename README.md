...
```
git clone https://github.com/mhalt/cpp-route-planner-project.git --recurse-submodules
```
or with SSH:
```
git clone git@github.com:mhalt/cpp-route-planner-project.git --recurse-submodules
```
